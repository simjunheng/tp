...
public class DeleteTagFromTaskCommand extends Command {
     ...
     */
    public DeleteTagFromTaskCommand(Index index, String tagName) {
    ...
    public boolean equals(Object other) {
        ...
        return other == this // short circuit if same object
                || (other instanceof DeleteTagFromTaskCommand // instanceof handles nulls
                && (index.equals(((DeleteTagFromTaskCommand) other).index)
                && tagName.equals((((DeleteTagFromTaskCommand) other).tagName))));
    }
