...
public class JsonSerializableTaskBookTest {
    ...
    private static final Path DUPLICATE_TASK_FILE = TEST_DATA_FOLDER.resolve("duplicateTasksTaskBook.json");
    ...
    public void toModelType_typicalTasksFile_success() throws Exception {
        ...
        assertEquals(addressBookFromFile, typicalTasksTaskBook);
    }
