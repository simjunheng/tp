...
class DeletePersonTagCommandTest {
    // Test tags
    ...
    void execute_deleteTagCommandUnfilteredList_success() {
        ...
        DeletePersonTagCommand deleteTagCommand = new DeletePersonTagCommand(INDEX_FIRST_PERSON, TAG_1);

        String expectedMessage = String.format(DeletePersonTagCommand.MESSAGE_DELETE_TAG_SUCCESS, TAG_1);
    ...
    public void execute_invalidPersonIndexFilteredList_failure() {
        ...
        AddPersonTagCommand addTagCommand = new AddPersonTagCommand(outOfBoundIndex, TAG_1);
    ...
    @Test
    public void equals() {
        final DeletePersonTagCommand command = new DeletePersonTagCommand(INDEX_FIRST_PERSON, TAG_1);
